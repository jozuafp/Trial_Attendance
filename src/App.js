            ...
            render={(props) => (
              <React.Fragment>
                ...
                <Class
                  ...
                  studentPresent={this.studentPresent}
                />

                {/* Redirect to summary page */}
                <Link to="/summary">
                  <button className="btn" onClick={this.gotoSummary}>
                    Submit
                  </button>
                </Link>
              </React.Fragment>
            ...
            render={(props) => (
              <React.Fragment>
                <div className="">
                  ...
                  {
                    this.state.students.filter((student) => student.present)
                      .length
                  }{" "}
                  students attended today's class
                </div>
